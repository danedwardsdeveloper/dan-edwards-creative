  ...
  return (
    <Container>
      ...
      >
        ...
        <ul>
          <li>
            We only request authorization to add music to your Spotify library
          </li>
          <li>We do not store any personal information</li>
          <li>
            We do not track, collect, or maintain any data about your Spotify
            account or usage
          </li>
          <li>
          ...
          <li>
            Once a pre-save is completed, we retain no access to your account
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            You agree to authorize our app with the minimum necessary
            permissions
          </li>
          <li>
        ...
        <p>
          All content on this website, including but not limited to music, text,
          graphics, logos, and images, is the property of Dan Edwards Creative
          or its content creators and protected by applicable copyright laws.
        </p>
        ...
        <p>
          Dan Edwards Creative shall not be liable for any indirect, incidental,
        ...
        <p>
          For any questions regarding these terms, please contact Dan using the
          email below:
        </p>
        <ObfuscatedEmail />
      </SimpleLayout>
