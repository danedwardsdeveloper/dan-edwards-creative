...
export default function PreSaveCard({ classes }: { classes?: string }) {
  ...
  return (
    <div className={clsx('group mx-auto max-w-md rounded-xl bg-slate-100 p-4 dark:bg-slate-800', classes)}>
      <Image
        src={pieceOfMeImage}
      ...
      <div className="flex flex-col space-y-3 pt-4">
        ...
        >
          ...
          <span className="ml-2 text-base font-semibold">Pre-Save on Spotify</span>
