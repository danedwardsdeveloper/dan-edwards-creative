...
import ObfuscatedEmail from '../contact/ObfuscatedEmail'
...
export default function PrivacyPolicyPage() {
  return (
    <SimpleLayout title={'Privacy policy & terms of service'} intro={'Updated: November 6, 2024'}>
      ...
      <p>
        All content on this website, including but not limited to music, text, graphics, logos, and images, is
        the property of Dan Edwards Creative or its content creators and protected by applicable copyright
        laws.
      </p>
